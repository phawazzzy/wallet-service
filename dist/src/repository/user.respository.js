...
var UserRepository = /** @class */ (function (_super) {
    ...
    function UserRepository(dbClient, modelFactory) {
    ...
    UserRepository = __decorate([
        ...
        __param(1, inversify_1.named('userModel')),
        __metadata("design:paramtypes", [mongodb_datasource_1.MongoDBDataSource, user_model_1.UserModel])
    ], UserRepository);
